...
function getKeystore(jwks) {
  ...
  return KeyStore.fromJWKS(jwks, { onlyPrivate: !this.signingOperation });
}
...
class BaseClient {
  ...
  constructor(issuer, aadIssValidation, metadata = {}, jwks, options) {
    ...
    if (options != null && options.signingOperation) {
      this.#signingOperation = options.signingOperation;
    }
...
<form method="post" action="${this.issuer.authorization_endpoint}">
  ...
  get signingOperation() {
    return this.#signingOperation;
  }
